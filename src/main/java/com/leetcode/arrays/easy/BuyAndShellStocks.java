 ...
 *         Example 1:
 * 
 *         Input: prices = [7,1,5,3,6,4] Output: 7 Explanation: Buy on day 2
 *         (price = 1) and sell on day 3 (price = 5), profit = 5-1 = 4. Then buy
 ...
 *         (price = 1) and sell on day 5 (price = 5), profit = 5-1 = 4. Total
 *         profit is 4. Example 3:
 * 
 *         Input: prices = [7,6,4,3,1] Output: 0 Explanation: There is no way to
 *         make a positive profit, so we never buy the stock to achieve the
 *         maximum profit of 0.
 * 
 * 
 *         Constraints:
 ...
 *
 */
public class BuyAndShellStocks {

	public static void main(String[] args) {

		int[] stocks = new int[] { 7, 1, 5, 3, 6, 4 };
		BuyAndShellStocks ms = new BuyAndShellStocks();
