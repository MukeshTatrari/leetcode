 ...
 *         hold the final result. It does not matter what you leave beyond the
 *         first k elements.
 * 
 ...
 *         nums[i] == expectedNums[i]; } If all assertions pass, then your
 ...
 *         Example 1:
 * 
 *         Input: nums = [1,1,2] Output: 2, nums = [1,2,_] Explanation: Your
 *         function should return k = 2, with the first two elements of nums
 ...
 *         [0,1,2,3,4,_,_,_,_,_] Explanation: Your function should return k = 5,
...
public class RemoveDuplicates {
	public static void main(String[] args) {
		...
		int unique = d.removeDuplicates(new int[] {1,1,2});
		System.out.println("total unique :: "+ unique);
	}
