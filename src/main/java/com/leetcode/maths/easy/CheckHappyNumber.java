 ...
 *         happy. Return true if n is a happy number, and false if not.
 * 
 * 
 * 
 *         Example 1:
 * 
 *         Input: n = 19 Output: true Explanation: 12 + 92 = 82 82 + 22 = 68 62
 *         + 82 = 100 12 + 02 + 02 = 1 Example 2:
 * 
...
public class CheckHappyNumber {
	...
	public static void main(String[] args) {
		CheckHappyNumber hp = new CheckHappyNumber();
		boolean isHappy = hp.isHappy1(19);
